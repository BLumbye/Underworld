...
namespace UnityEngine {
    ...
    /// </summary>
    [Serializable]
    [CreateAssetMenu(fileName = "New Rule Tile Plus", menuName = "Tiles/Rule Tile Plus")]
    public class RuleTilePlus : TileBase {
        /// <summary>
        ...
        public class TilingRule : TilingRuleOutput {
            ...
            /// <summary>
            /// * Preset this list to RuleTilePlus backward compatible, but not support for HexagonalRuleTile backward compatible.
            /// </summary>
        ...
        /// </summary>
        [HideInInspector] public List<TilingRule> m_TilingRules = new List<RuleTilePlus.TilingRule>();
                ...
                if (RuleMatches(rule, position, tilemap, ref transform)) {
                    switch (rule.m_Output) {
                        ...
                        case TilingRule.OutputSprite.Random:
                            ...
                            break;
                        case TilingRule.OutputSprite.WeightedRandom:
                            if (rule.m_Sprites == null || rule.m_Sprites.Length <= 0) return;
                            ...
                            var cumulativeWeight = rule.m_Weights.Sum();
        ...
        public FieldInfo[] GetCustomFields(bool isOverrideInstance) {
            return this.GetType().GetFields()
                .Where(field => typeof(RuleTilePlus).GetField(field.Name) == null)
                .Where(field => !field.IsDefined(typeof(HideInInspector)))
                .Where(field => !isOverrideInstance || !field.IsDefined(typeof(RuleTilePlus.DontOverride)))
                .ToArray();
        }
